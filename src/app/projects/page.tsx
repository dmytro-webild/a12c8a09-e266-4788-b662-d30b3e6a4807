          ...
          <div className="space-y-40">
            {projects.map((project, index) => (
              <div key={project.id} className="space-y-12">
                ...
                <div className="bg-[var(--card)] p-12 rounded-3xl border border-[var(--accent)] shadow-2xl">
