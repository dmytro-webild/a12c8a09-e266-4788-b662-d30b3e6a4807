...
export default function ProjectsPage() {
  const [reasonings, setReasonings] = useState<Record<string, string>>({ 
    "p1": "Idee luua oma jalgpalliklubi tuli juba 9. klassis. Mõtlesime teha tiimi, mis hakkaks osalema Rahvaliigas, sest paljud meist mängisid juba jalgpalli nii trennis kui ka koolis sõpradega. Oskused ja huvi olid olemas ning vaja oli ainult idee päriselt ellu viia. Pärast ettevalmistusi ja treeningute toimus meie esimene ametlik mäng 2024. aasta suvel. See oli meie jaoks väga oluline hetk, sest nägime, et väikesest mõttest oli saanud päris jalgpalliklubi. Hiljem osalesime mitmetel turniiridel ning mängisime ka Rahvaliiga B-grupis, kus saime palju uusi kogemusi ja arenesime meeskonnana edasi. Lisaks mängimisele panustasin ka klubi kujunduse ja sotsiaalmeedia poole pealt. Kujundasin ise meie meeskonna särgi ning tegin mõned sotsiaalmeedia postitused, et jagada klubi tegemisi ja tulemusi. Meeskonnas mängin ründajana, kus minu ülesanne on aidata tiimi väravate löömise ja rünnakute loomisega. See projekt õpetas mulle palju meeskonnatööst, vastutuse võtmisest ja loovusest. Samuti sain kogemuse, kuidas ühest lihtsast ideest võib koos sõpradega kasvada päris toimiv jalgpalliklubi.",    "p2": "Olen tantsinud juba 10 aastat tantsuklubis Esperanza, kus tegelesin võistlustantsuga. Kogu selle aja tantsisin ühe kindla tantsupartneriga, Alisa Milvoa, kellega arenesime koos väga tugevaks tantsupaariks. Olen osalenud rohkem kui 100 võistlusel ning saanud selle aja jooksul palju väärtuslikke kogemusi nii tantsus kui ka esinemises. Oleme mitmel korral jõudnud Eesti meistrivõistlustel poodiumile, mis on olnud üks meie suurimaid saavutusi. Lisaks Eestis toimunud võistlustele oleme osalenud ka välismaa võistlustel ja laagrites, kus saime õppida uutelt treeneritelt, arendada oma oskusi ning kogeda erinevaid tantsustiile ja võistluskultuure. Tantsimine on õpetanud mulle distsipliini, pühendumist ja meeskonnatööd. Pikaajaline kogemus võistlustantsus on aidanud mul arendada enesekindlust, vastupidavust ja oskust töötada eesmärkide nimel järjepidevalt."
  });
