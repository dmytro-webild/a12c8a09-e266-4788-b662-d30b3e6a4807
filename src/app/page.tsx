...
export default function LandingPage() {
  ...
  <div id="projects" data-section="projects">
      ...
      features={[
        ...
        { id: "p3", title: "Klienditeenindus", description: "Olen töötanud Decathlonis, kus minu peamisteks ülesanneteks oli klientide nõustamine spordivarustuse valimisel, toodete väljapanek ja klientide rahulolu tagamine. See kogemus on õpetanud mulle suurepärast suhtlemisoskust, kannatlikkust ja võimet leida lahendusi ka kiiretes ning keerulistes olukordades.", tag: "Teenindus", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DXy63pHOXTf1wMgW8x6XNMvtik/uploaded-1778671852101-8oq8hsvm.jpg?_wi=1" },
