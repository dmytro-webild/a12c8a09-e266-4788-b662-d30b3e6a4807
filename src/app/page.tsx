...
export default function LandingPage() {
  ...
  <div id="projects" data-section="projects">
      ...
      useInvertedBackground={false}
      features={[
        { id: "p1", title: "Võistlustantsu projekt", author: "Lazar Uleksin", description: "Rahvaliiga klubi loomine", tags: ["Jalgpall ", "Meeskond"], imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DXy63pHOXTf1wMgW8x6XNMvtik/uploaded-1778530873115-vm1ju69k.png" },
        ...
        { id: "p4", title: "Uus Projekt 1", author: "Lazar Uleksin", description: "Kirjeldus siia.", tags: ["Uus", "Innovatsioon"], imageSrc: "http://img.b2bpic.net/free-photo/hispanic-woman-using-digital-tablet_53876-95581.jpg?_wi=2" },
        { id: "p5", title: "Uus Projekt 2", author: "Lazar Uleksin", description: "Kirjeldus siia.", tags: ["Uus", "Innovatsioon"], imageSrc: "http://img.b2bpic.net/free-photo/hispanic-woman-using-digital-tablet_53876-95581.jpg?_wi=2" }
      ]}
