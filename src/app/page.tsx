...
export default function LandingPage() {
  ...
  <div id="projects" data-section="projects">
      ...
      features={[
        ...
        { id: "p2", title: "Võistlustants ", description: "Olen aktiivselt tegelenud tantsimisega tantsuklubis Esperanza, kus olen arendanud nii oma tehnilisi oskusi kui ka esinemisjulgust. Tantsimine on õpetanud mulle distsipliini ja järjepidevust, aidates mul saavutada häid tulemusi nii kohalikel kui ka rahvusvahelistel võistlustel. Meeskonnatöö tantsuklubis on olnud hindamatu kogemus, mis on kujundanud mind selliseks, nagu olen täna.", tag: "Tants", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DXy63pHOXTf1wMgW8x6XNMvtik/uploaded-1778531466534-7mwwuifz.jpg?_wi=1" },
