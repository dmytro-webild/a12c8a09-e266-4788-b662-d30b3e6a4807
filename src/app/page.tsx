...
export default function LandingPage() {
  ...
  <div id="projects" data-section="projects">
      ...
      features={[
        ...
        { id: "p3", title: "Klienditeenindus", description: "Töötan hetkel Decathlon Tallinna ainsas poes, mis asub Kurna pargis ning on ühtlasi suurim Decathloni pood Baltikumis. Igapäevaseks tööks on service-osakonnas kassatööd ja klienditeenindus.", tag: "Teenindus", imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3DXy63pHOXTf1wMgW8x6XNMvtik/uploaded-1778671852101-8oq8hsvm.jpg?_wi=1" },
